...
# =========================================================
# Tokens de un solo uso para recuperar la contraseña por email.
#
# Seguridad:
# - Solo se guarda el hash SHA-256 del token, nunca en claro.
# - Caducan en 1 hora.
# - Se marcan como usados tras el primer uso (campo used_at).
# - Al pedir uno nuevo se invalidan los anteriores del mismo usuario.
# =========================================================
